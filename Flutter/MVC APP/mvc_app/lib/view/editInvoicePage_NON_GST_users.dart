...
import 'package:mvc_app/view/updateInvoice_Non_GST.dart';
import 'package:pdf/pdf.dart';
import 'package:share/share.dart';

import '../model/carModel.dart';

class editInvoicePage_Non_GST_users extends StatefulWidget {
  @override
  _editInvoicePage_Non_GST_usersState createState() =>
      _editInvoicePage_Non_GST_usersState();
}

class _editInvoicePage_Non_GST_usersState
    extends State<editInvoicePage_Non_GST_users> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: Text(''),
        title: Text('Edit Quotation Non GST'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore
            .collection('invoices')
            .where('userId', isEqualTo: _currentUserId)
            .where('isGst', isEqualTo: false)
            .snapshots(),
                      ...
                      return Column(
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            onTap: () async {
                              final String filePath = await generatePDF_Non_GST(
                  ...
                  trailing: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => updateInvoice_Non_GST(
