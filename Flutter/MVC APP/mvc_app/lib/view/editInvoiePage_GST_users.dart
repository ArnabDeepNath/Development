...
class editInvoicePage_GST_users extends StatefulWidget {
  @override
  _editInvoicePage_GST_usersState createState() =>
      _editInvoicePage_GST_usersState();
}

class _editInvoicePage_GST_usersState extends State<editInvoicePage_GST_users> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: Text(''),
        title: Text('Edit Quotation GST , User Edition'),
      ),
