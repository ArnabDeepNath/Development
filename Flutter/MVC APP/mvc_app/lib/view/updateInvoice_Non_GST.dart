...
class updateInvoice_Non_GST extends StatefulWidget {
  String selectedLob;
  ...
  @override
  State<updateInvoice_Non_GST> createState() => _updateInvoice_Non_GSTState();
}

class _updateInvoice_Non_GSTState extends State<updateInvoice_Non_GST> {
  List items = [];
  String itemName = '';
  int itemQuantity = 0;
  ...
  void initState() {
    ...
    _tcs = widget.tcs;
    temp = widget.temp_regn;
    hsrp = widget.hsrp;
    totalTax = widget.totalTax;
    grandTotal = widget.totalAfterTax;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Update Invoice Non GST'),
      ),
        ...
        child: Column(
          children: [
            ...
            MaterialButton(
              ...
              onPressed: () async {
                _calEvery();
                FirebaseService().updateInvoice_Non_GST(
                  _quotation_no,
                  _date!,
                  _name,
                  _address,
...
class PDFViewerScreen_Non_Gst extends StatelessWidget {
  final String filePath;
  final bool share;

  PDFViewerScreen_Non_Gst({
    Key? key,
